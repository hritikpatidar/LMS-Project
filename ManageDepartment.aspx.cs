...
public partial class ManageDepartment : System.Web.UI.Page
{
    ...
    private void OnLoad()
    {
        string query = "SELECT * FROM [departments] as Departments";
    ...
    protected void btnUpdate_click(object sender, EventArgs e)
    {
        ...
        int id = Convert.ToInt16(GrdDept.DataKeys[rowIndex].Values["DepartmentId"].ToString());
        //GrdDept.DataKeys[0].Value[""].ToString();
        string h = "hello";
        Response.Redirect("Department.aspx?id=" + id + "");
